...
SCHEMA = {
  ...
  "Notifications": {
    "notifications.ntfy": {
      ...
      "combat.enabled": {"type": "bool", "label": "Combat/safety: enabled"},
      "combat.priority": {"type": "int", "min": 1, "max": 5, "label": "Combat/safety: priority"},
      "combat.tags": {"type": "string", "label": "Combat/safety: tags"},
      "security.enabled": {"type": "bool", "label": "Proxy security: enabled"},
      "security.priority": {"type": "int", "min": 1, "max": 5, "label": "Proxy security: priority"},
      "security.tags": {"type": "string", "label": "Proxy security: tags"},
      "proxyAccess.enabled": {"type": "bool", "label": "Proxy access: enabled"},
      "proxyAccess.priority": {"type": "int", "min": 1, "max": 5, "label": "Proxy access: priority"},
      "proxyAccess.tags": {"type": "string", "label": "Proxy access: tags"},
      "queue.enabled": {"type": "bool", "label": "Queue lifecycle: enabled"},
      "queue.priority": {"type": "int", "min": 1, "max": 5, "label": "Queue lifecycle: priority"},
      "queue.tags": {"type": "string", "label": "Queue lifecycle: tags"},
      "accountAlert.enabled": {"type": "bool", "label": "Account alerts: enabled"},
      "accountAlert.priority": {"type": "int", "min": 1, "max": 5, "label": "Account alerts: priority"},
      "accountAlert.tags": {"type": "string", "label": "Account alerts: tags"},
      "maintenance.enabled": {"type": "bool", "label": "Maintenance: enabled"},
      "maintenance.priority": {"type": "int", "min": 1, "max": 5, "label": "Maintenance: priority"},
      "maintenance.tags": {"type": "string", "label": "Maintenance: tags"},
    },
  },
  "Advanced": {
